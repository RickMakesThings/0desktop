...
sudo dnf -y install bspwm sxhkd picom lightdm rofi feh dunst pavucontrol alacritty nemo nemo-compare nemo-fileroller nemo-image-converter nano firefox xorg-x11-server-xorg roboto baobab gnome-calendar gnome-clocks gnome-calculator gnome-system-monitor gnome-screenshot cava nm-connection-editor blueberry ffmpeg ffmpegthumbnailer redshift timeshift protonvpn-cli playerctl kde-connect
...
#picom
sudo cp /usr/share/doc/picom/examples/picom.sample.conf ~/.config/picom/picom.conf
#lightdm
sudo cp /usr/lib/systemd/system/lightdm.service /etc/systemd/system/
sudo systemctl enable lightdm.service
#rofi
sudo cp /usr/share/doc/rofi/examples/config.rasi ~/.config/rofi/config.rasi
#logiops
